export default {
  ...
  schedule: {
    ...
    gameCount: '{{n}} games',
    noGamesForTeam: 'No games against this team yet. Schedule one to start.',
    noTeams: 'No teams yet. Add the first club you play.',
    addTeam: 'Add Team',
    newTeamPlaceholder: 'New club or team name...',
    unassignedTeam: 'No opponent yet',
    toggleGames: 'Show or hide games',
    saveContact: 'Save Contact',
    unsavedTeam: 'Not in contacts',
    saveContactHint: 'This team is not in your contacts yet. Save it to add their contact details.',
    removeTeamHint: 'Remove this team from your contacts. Its games stay on the planner.',
    contactNotesPlaceholder: 'Contact notes...',
  },
