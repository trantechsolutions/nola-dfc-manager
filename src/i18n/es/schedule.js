export default {
  ...
  schedule: {
    ...
    gameCount: '{{n}} partidos',
    noGamesForTeam: 'Aún no hay partidos contra este equipo. Programa uno para empezar.',
    noTeams: 'Aún no hay equipos. Agrega el primer club contra el que juegas.',
    addTeam: 'Agregar Equipo',
    newTeamPlaceholder: 'Nombre del nuevo club o equipo...',
    unassignedTeam: 'Sin rival asignado',
    toggleGames: 'Mostrar u ocultar partidos',
    saveContact: 'Guardar Contacto',
    unsavedTeam: 'Sin contacto',
    saveContactHint: 'Este equipo aún no está en tus contactos. Guárdalo para agregar sus datos de contacto.',
    removeTeamHint: 'Quita este equipo de tus contactos. Sus partidos siguen en el planificador.',
    contactNotesPlaceholder: 'Notas del contacto...',
  },
