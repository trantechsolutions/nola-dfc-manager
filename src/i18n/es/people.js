export default {
  ...
  parent: {
    ...
    uploadMedical: 'Subir Doc. Médico',
    ...
    docUploadFail: 'No se pudo subir el documento',
    docTooLarge: 'Archivo demasiado grande (máx. 10MB)',
    medicalUploadHelp:
      'Se archiva como la Autorización Médica de la temporada. Visible solo para tutores y gerentes del equipo.',
    reeplayer: 'ReePlayer',
  ...
  overview: {
    ...
    docCompliance: 'Cumplimiento',
    fullyCompliant: 'Totalmente en Cumplimiento',
    complianceRequired: 'Obligatorias',
    complianceOptional: 'Opcionales',
    complianceOptionalNote: 'No cuentan para el cumplimiento total.',
