...
export function SkeletonLine({ width = 'w-full', height = 'h-4', className = '' }) {
  return <div className={`${width} ${height} bg-muted rounded-lg animate-pulse ${className}`} />;
}

export function SkeletonCard({ className = '' }) {
  return (
    <div className={`bg-card rounded-lg border border-border p-5 space-y-3 ${className}`}>
...
export function SkeletonParentView() {
  return (
    <div className="space-y-5 animate-in fade-in duration-300">
      {/* Player card */}
      <div className="bg-gradient-to-br from-primary to-primary/80 rounded-lg p-6 space-y-4">
