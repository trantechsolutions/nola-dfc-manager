...
import { txActivityDate } from '../utils/txDates';
...
export default function StatementImportModal({
  ...
  // The activity date — the only one a statement can be matched against
  // (mirrors compareStatement logic).
  const txDate = txActivityDate;
  ...
  return (
    ...
    >
      ...
      <ResponsiveModal.Body className="space-y-5">
        ...
        {!csvText && (
          ...
          >
            ...
            <p className="text-sm font-semibold text-foreground mb-1">Drop a CSV statement here, or click to browse</p>
            <p className="text-xs text-muted-foreground mb-4">
              Accepts any CSV with a date and amount column — description is optional. Works with Chase, Venmo, PayPal,
              and most bank exports.
            </p>
            ...
            {showMapper && !autoDetected.isMinimalFormat && (
              <div className="px-4 py-4 border-t border-border space-y-3">
                <p className="text-xs text-muted-foreground font-medium">
                  Map each app field to the matching column in your CSV. Columns detected automatically are pre-selected
          ...
          <>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 rounded-lg p-3 text-center">
                <p className="text-xl font-bold text-emerald-700 dark:text-emerald-300 tabular-nums">{totalMatched}</p>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground font-medium mt-0.5">
                    Click any unmatched row to select it, then click its counterpart on the other side to link them as a
                    manual match.
                  </p>
                  {pendingMatch && (
                    <button
                  ...
                  {result.statementOnly.map((row, i) => {
                    ...
                    return (
                      <StmtRow
                        ...
                        bgClass={isSelected ? 'bg-blue-50 dark:bg-blue-950/30' : 'bg-amber-50/50 dark:bg-amber-950/20'}
