...
const EVENT_GROUPS = [
  // ── TOURNAMENTS (matched by description keywords from iCal) ──
  {
    ...
    type: 'tournament',
    eventKeywords: ['mm tournament'],
    txKeywords: ['midnight madness'],
  },
  {
    id: 'stysa-fall',
    name: 'STYSA Fall Classic / Deep South',
    type: 'tournament',
    eventKeywords: ['deep south challenge', 'stysa'],
    txKeywords: ['stysa tournament', 'stysa fall'],
  },
  {
    id: 'gulf-coast-fall',
    name: 'Gulf Coast Fall Classic',
    type: 'tournament',
    eventKeywords: ['gulf coast fall'],
    txKeywords: ['gulfport tournament', 'gulf coast fall'],
  },
  {
    id: 'gobbler-cup',
    name: 'Gobbler Cup',
    type: 'tournament',
    eventKeywords: ['gobbler'],
    txKeywords: ['gobbler cup', 'houma bayou'],
  },
  {
    id: 'fairhope',
    name: 'Fairhope Spring Blast',
    type: 'tournament',
    eventKeywords: ['fairhope spring blast', 'fairhope'],
    txKeywords: ['fairhope'],
  },
  {
    id: 'gulf-coast-spring',
    name: 'Gulfport Player Cup & Showcase',
    type: 'tournament',
    eventKeywords: ['gulfport player cup', 'gulfport showcase'],
    txKeywords: ['gulfport player cup', 'gulfport showcase'],
  },
  {
    id: 'red-stick',
    name: 'Red Stick Tournament',
    type: 'tournament',
    eventKeywords: ['red stick'],
    txKeywords: ['red stick'],
  },
  {
    id: 'bayou-shootout',
    name: 'Bayou Shootout',
    type: 'tournament',
    eventKeywords: ['bayou shootout'],
    txKeywords: ['bayou shootout'],
  },
  {
    id: 'gulf-coast-cup',
    name: 'Gulf Coast Cup & Showcase',
    type: 'tournament',
    eventKeywords: ['gulf coast cup'],
    txKeywords: ['gulf coast cup'],
  },
  ...
  {
    id: 'st-charles',
    name: 'St. Charles League',
    type: 'league',
    eventKeywords: ['st charles league'],
    txKeywords: ['st charles'],
  },
];
...
export function buildEventMatchReport(events, transactions) {
  ...
  const relevantTx = transactions.filter((tx) => ['TOU', 'LEA', 'FRI'].includes(tx.category) && !tx.waterfallBatchId);
