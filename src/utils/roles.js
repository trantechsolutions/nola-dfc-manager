...
export const CLUB_ROLES = {
  club_admin:   { label: 'Club Admin',    level: 'club', description: 'Full access to everything. Manage teams, roles, club settings.' },
  club_manager: { label: 'Club Manager',  level: 'club', description: 'View access to any team. Cannot modify club settings or roles.' },
};
...
export const TEAM_ROLES = {
  ...
  assistant_coach:  { label: 'Assistant Coach',    level: 'team', description: 'View-only access to roster, schedule, and player compliance.' },
};
