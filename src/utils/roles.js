...
export const ROLE_PERMISSIONS = {
  ...
  head_coach: [PERMISSIONS.TEAM_VIEW_ROSTER, PERMISSIONS.TEAM_VIEW_SCHEDULE, PERMISSIONS.TEAM_VIEW_BUDGET],

  assistant_coach: [PERMISSIONS.TEAM_VIEW_ROSTER, PERMISSIONS.TEAM_VIEW_SCHEDULE],
};
